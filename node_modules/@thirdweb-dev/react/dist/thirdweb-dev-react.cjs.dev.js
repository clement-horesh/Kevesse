...
var useWalletConnect = require('./useWalletConnect-ad213751.cjs.dev.js');
var frameWallet = require('./frameWallet-e5c7fc09.cjs.dev.js');
var paperWallet = require('./paperWallet-2b5cc92d.cjs.dev.js');
var RainbowWallet = require('./RainbowWallet-3bac0d60.cjs.dev.js');
var safeWallet = require('./safeWallet-8c8399d3.cjs.dev.js');
var TrustWallet = require('./TrustWallet-953aa976.cjs.dev.js');
var walletConnectV1 = require('./walletConnectV1-5ba1809c.cjs.dev.js');
var magicLink = require('./magicLink-d43908b3.cjs.dev.js');
var handleWCSessionRequest = require('./handleWCSessionRequest-31f47cbe.cjs.dev.js');
var bloctoWallet = require('./bloctoWallet-9b4885f2.cjs.dev.js');
var useSafe = require('./useSafe-fcce3695.cjs.dev.js');
...
const ZerionConnectUI = props => {
  ...
  if (screen === "open-wc-uri") {
    return /*#__PURE__*/jsxRuntime.jsx(handleWCSessionRequest.WCOpenURI, {
      hideBackButton: hideBackButton,
      onBack: props.goBack,
      onConnected: close,
...
const zerionWallet = options => {
  return {
    ...
    create: walletOptions => {
      ...
      handleWCSessionRequest.handelWCSessionRequest(wallet, zerionWalletUris);
      return wallet;
    },
