...
export declare class AccountPermissions implements DetectableFeature {
    featureName: "AccountPermissions";
    ...
    private sendSignerPermissionRequest;
    private buildSignerPermissionRequest;
    /**
...
//# sourceMappingURL=account-permissions.d.ts.map