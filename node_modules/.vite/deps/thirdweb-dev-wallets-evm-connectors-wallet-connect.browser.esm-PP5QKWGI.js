  ...
  async switchChain(chainId) {
    ...
    try {
      ...
      if (!isChainApproved && namespaceMethods.includes(ADD_ETH_CHAIN_METHOD)) {
        const blockExplorerUrls = ((_a = chain.explorers) == null ? void 0 : _a.length) ? {
...
async function _initProvider2() {
  const {
    ...
    OPTIONAL_EVENTS,
    OPTIONAL_METHODS
  } = await import("./index.es-B7GRL6OW.js");
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-wallet-connect.browser.esm-PP5QKWGI.js.map
