...
// node_modules/@thirdweb-dev/react/dist/headlessConnectUI-c1f84a4b.browser.esm.js
init_shim();
...
var GetStartedScreen = (_ref) => {
  ...
  const [showScreen, setShowScreen] = (0, import_react7.useState)("base");
  ...
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, {
    children: [(0, import_jsx_runtime.jsx)(BackButton, {
    ...
    }), showScreen === "android-scan" && googlePlayStoreLink && (0, import_jsx_runtime.jsx)(ScanScreen$1, {
      ...
      walletName,
      walletIconURL
    }), showScreen === "ios-scan" && appleStoreLink && (0, import_jsx_runtime.jsx)(ScanScreen$1, {
      platformIcon: (0, import_jsx_runtime.jsx)(Img, {
        width: iconSize.md,
        height: iconSize.md,
        src: Apple
...
var CoinbaseScan = (_ref) => {
  ...
  const [qrCodeUri, setQrCodeUri] = (0, import_react7.useState)(void 0);
  const {
    setConnectedWallet,
    chainToConnect,
    setConnectionStatus
  } = useWalletContext();
  const scanStarted = (0, import_react7.useRef)(false);
...
var CoinbaseConnectUI = (_ref) => {
  ...
  const [screen, setScreen] = (0, import_react7.useState)("loading");
  ...
  return {
    ...
    isInstalled() {
      ...
      if (assertWindowEthereum(window_)) {
        return ((_a = window_.ethereum) == null ? void 0 : _a.isCoinbaseWallet) || ((_c = (_b = window_.ethereum) == null ? void 0 : _b.providers) == null ? void 0 : _c.some((p) => p.isCoinbaseWallet)) || false;
      }
      return false;
    }
  };
...
var CoinbaseNativeModalConnectUI = (_ref) => {
  ...
  const prompted = (0, import_react7.useRef)(false);
...
var MetamaskScan = (_ref) => {
  ...
  const createInstance = useCreateWalletInstance();
  const [qrCodeUri, setQrCodeUri] = (0, import_react7.useState)();
  const {
    setConnectedWallet,
    chainToConnect,
    setConnectionStatus
...
var MetamaskConnectUI = (props) => {
  var _a, _b, _c;
  const [screen, setScreen] = (0, import_react7.useState)("connecting");
  const {
    walletConfig,
    close
  } = props;
...
var defaultWallets = (() => [metamaskWallet(), coinbaseWallet(), walletConnect()])();
var WalletModalOpen = (0, import_react7.createContext)(false);
var SetWalletModalOpen = (0, import_react7.createContext)(void 0);
var ModalConfigCtx = (0, import_react7.createContext)({
  title: "",
  theme: "dark",
  data: void 0
});
var SetModalConfigCtx = (0, import_react7.createContext)(() => {
});
var WalletUIStatesProvider = (props) => {
  const [isWalletModalOpen, setIsWalletModalOpen] = (0, import_react7.useState)(false);
  const [modalConfig, setModalConfig] = (0, import_react7.useState)({
...
var useIsWalletModalOpen = () => {
  return (0, import_react7.useContext)(WalletModalOpen);
};
var useSetIsWalletModalOpen = () => {
  const context = (0, import_react7.useContext)(SetWalletModalOpen);
  if (context === void 0) {
...
var WalletSelection = (props) => {
  ...
  return (0, import_jsx_runtime.jsx)(WalletListContainer, {
...
var WalletListContainer = newStyled.ul`
  all: unset;
...
@license MIT
*/
//# sourceMappingURL=chunk-IU6QD7IB.js.map
