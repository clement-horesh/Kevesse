import {
  trustWallet
} from "./chunk-PDVR6GG6.js";
import {
  frameWallet
} from "./chunk-AK2ZESBG.js";
import {
  bloctoWallet
} from "./chunk-XNJDTXRH.js";
import {
  paperWallet
} from "./chunk-F5ILBCSX.js";
import {
  walletConnectV1
} from "./chunk-7WUHLOQT.js";
import {
  safeWallet
} from "./chunk-DFLD3GNC.js";
import {
  ...
  ToolTip,
  magicLink
} from "./chunk-UPTZ34CC.js";
import {
  TextDivider
} from "./chunk-IAS6GBJR.js";
import {
  rainbowWallet
} from "./chunk-72DGLSAF.js";
import {
  WCOpenURI,
  handelWCSessionRequest
} from "./chunk-3XYDR5EC.js";
import {
...
import {
  getRpcUrl
} from "./chunk-IGFMHEFN.js";
import "./chunk-FPWLOE4Q.js";
import {
  ...
  watchTransactions
} from "./chunk-OITP2JHM.js";
import {
  TokenERC20History
} from "./chunk-JYYVZVO4.js";
import {
  StandardErc20
} from "./chunk-W2P2ZSKS.js";
import {
  VoteType
} from "./chunk-RRAXJSXB.js";
import {
  hasERC20Allowance
} from "./chunk-HM7GPNQ3.js";
import {
  StandardErc721
} from "./chunk-LXNR34M2.js";
import {
  DropErc1155History
} from "./chunk-C7AEONIZ.js";
import {
  PAPER_API_URL,
  PaperCheckout,
...
} from "./chunk-MZGARGKH.js";
import {
  StandardErc1155
} from "./chunk-TPWRKQDP.js";
import {
  ListingType,
  MarketplaceAuction,
  MarketplaceDirect
} from "./chunk-BIIRSSDI.js";
import {
  ALL_ROLES,
  AbiObjectSchema,
  AbiSchema,
...
// node_modules/@thirdweb-dev/react/dist/useWalletConnect-07d98711.browser.esm.js
init_shim();
...
var $69cb30bb0017df05$export$b2539bed5023c21c = (0, import_react5.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react5.createElement)($69cb30bb0017df05$var$TabsProvider, {
    scope: __scopeTabs,
...
var $69cb30bb0017df05$export$9712d22edc0d78c1 = (0, import_react5.forwardRef)((props, forwardedRef) => {
  const { __scopeTabs, loop = true, ...listProps } = props;
  const context = $69cb30bb0017df05$var$useTabsContext($69cb30bb0017df05$var$TAB_LIST_NAME, __scopeTabs);
  const rovingFocusGroupScope = $69cb30bb0017df05$var$useRovingFocusGroupScope(__scopeTabs);
  return (0, import_react5.createElement)($d7bdfb9eb0fdf311$export$be92b6f5f03c0fe9, _extends({
    asChild: true
...
var $69cb30bb0017df05$export$8114b9fdfdf9f3ba = (0, import_react5.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react5.createElement)($d7bdfb9eb0fdf311$export$6d08773d2e66f8f2, _extends({
    asChild: true
  }, rovingFocusGroupScope, {
    focusable: !disabled,
    active: isSelected
...
var $69cb30bb0017df05$export$bd905d70e8fd2ebb = (0, import_react5.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react5.createElement)(
    ...
    ({ present }) => (0, import_react5.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({
      "data-state": isSelected ? "active" : "inactive",
      "data-orientation": context.orientation,
      role: "tabpanel",
...
var ExportLocalWallet = (props) => {
  ...
  const [isWrongPassword, setIsWrongPassword] = (0, import_react8.useState)(false);
  const [passwordIsRequired, setPasswordIsRequired] = (0, import_react8.useState)(false);
  const wallet = useWallet();
  const address = useAddress();
  const [savedAddress, setSavedAddress] = (0, import_react8.useState)("");
...
function useClipboard(text) {
  ...
  const [hasCopied, setHasCopied] = (0, import_react8.useState)(false);
  const {
    timeout = 1500,
    ...copyOptions
  ...
  const onCopy = (0, import_react8.useCallback)(() => {
...
var NetworkSelector = (props) => {
  ...
  const deferredSearchTerm = (0, import_react8.useDeferredValue)(searchTerm);
  const themeFromProvider = (0, import_react8.useContext)(ThirdwebThemeContext);
  ...
  const recentChains = (0, import_react8.useMemo)(() => {
    if (deferredSearchTerm === "") {
  ...
  const handleSwitch = (0, import_react8.useCallback)((chain) => {
    if (onSwitch) {
      onSwitch(chain);
    }
    if (onClose) {
...
var NetworkTab = (props) => {
  const allChains = (0, import_react8.useMemo)(() => filterChainByType(props.allChains, props.type), [props.type, props.allChains]);
  const recentChains = (0, import_react8.useMemo)(() => filterChainByType(props.recentChains || [], props.type), [props.type, props.recentChains]);
  const popularChains = (0, import_react8.useMemo)(() => filterChainByType(props.popularChains || [], props.type), [props.type, props.popularChains]);
...
var NetworkList = (0, import_react8.memo)(function NetworkList2(props) {
  const switchChain = useSwitchChain();
  const activeChainId = useChainId();
  const [switchingChainId, setSwitchingChainId] = (0, import_react8.useState)(-1);
  const [errorSwitchingChainId, setErrorSwitchingChainId] = (0, import_react8.useState)(-1);
  ...
  const [isLoading, setIsLoading] = (0, import_react8.useState)(props.chains.length > 100);
  (0, import_react8.useEffect)(() => {
    if (isLoading) {
      setIsLoading(false);
    }
...
var ConnectedWalletDetails = (props) => {
  ...
  const [showExportModal, setShowExportModal] = (0, import_react8.useState)(false);
  const [wrapperWallet, setWrapperWallet] = (0, import_react8.useState)();
  const walletContext = useWalletContext();
  const chain = useChain();
  const activeWalletIconURL = (activeWalletConfig == null ? void 0 : activeWalletConfig.meta.iconURL) || "";
  const [showNetworkSelector, setShowNetworkSelector] = (0, import_react8.useState)(false);
  ...
  const content = (0, import_jsx_runtime.jsxs)("div", {
    children: [(0, import_jsx_runtime.jsxs)(Flex, {
      ...
      }), activeWalletConfig && activeWalletConfig.id === walletIds.metamask && activeWalletConfig.isInstalled && activeWalletConfig.isInstalled() && !isMobile() && (0, import_jsx_runtime.jsxs)(MenuButton, {
        type: "button",
        onClick: () => {
...
var ConnectWallet = (props) => {
  ...
  const setModalConfig = (0, import_react8.useContext)(SetModalConfigCtx);
  const address = useAddress();
  const [showSignatureModal, setShowSignatureModal] = (0, import_react8.useState)(false);
...
function SwitchNetworkButton(props) {
  ...
  const switchChain = useSwitchChain();
  const [switching, setSwitching] = (0, import_react8.useState)(false);
  return (0, import_jsx_runtime.jsx)(AnimatedButton, {
...
var ModelViewer = (0, import_react8.lazy)(() => import("./ModelViewer-fde23dd9.browser.esm-XUWHMFMV.js"));
var PlayButton = (_ref) => {
  let {
    onClick,
    isPlaying
...
var VideoPlayer = import_react8.default.forwardRef((_ref2, ref) => {
  let {
    src,
    alt,
    poster,
  ...
  const [playing, setPlaying] = (0, import_react8.useState)(!requireInteraction);
  const [muted, setMuted] = (0, import_react8.useState)(true);
  (0, import_react8.useEffect)(() => {
    if (videoRef.current) {
      if (playing) {
        try {
...
var AudioPlayer = import_react8.default.forwardRef((_ref3, ref) => {
  let {
    src,
    alt,
    poster,
...
var IframePlayer = import_react8.default.forwardRef((_ref4, ref) => {
  let {
    src,
    alt,
    poster,
...
var LinkPlayer = import_react8.default.forwardRef((_ref5, ref) => {
  let {
    src,
    alt,
    style,
...
var MediaRenderer = import_react8.default.forwardRef((_ref6, ref) => {
  let {
    src,
    poster,
    alt,
  ...
  if (!videoOrImageSrc.mimeType) {
    ...
    return (0, import_jsx_runtime.jsx)(import_react8.Suspense, {
...
function useResolvedMediaType(uri, mimeType, gatewayUrl) {
  const storage = useStorage();
  const resolvedUrl = (0, import_react8.useMemo)(() => {
    if (!uri) {
      return "";
    }
    if (gatewayUrl) {
...
var ThirdwebNftMedia = import_react8.default.forwardRef((_ref, ref) => {
  var _a;
  let {
    metadata,
    width = "300px",
...
var Web3Button = (_ref) => {
  ...
  const thirdwebTheme = (0, import_react8.useContext)(ThirdwebThemeContext);
  const themeToUse = theme || thirdwebTheme || "dark";
  const [confirmStatus, setConfirmStatus] = (0, import_react8.useState)("idle");
...
var ConnectModal = () => {
  const {
    theme,
    title
  } = (0, import_react8.useContext)(ModalConfigCtx);
  const walletConfigs = useWallets();
  ...
  const connectionStatus = useConnectionStatus();
  const wallet = useWallet();
  const walletModalConfig = (0, import_react8.useContext)(ModalConfigCtx);
  const setWalletModalConfig = (0, import_react8.useContext)(SetModalConfigCtx);
  const disconnect = useDisconnect();
  const handleClose = (0, import_react8.useCallback)(function() {
  ...
  const handleBack = (0, import_react8.useCallback)(() => {
    setScreen(initialScreen);
  }, [setScreen, initialScreen]);
  ...
  const prevConnectionStatus = (0, import_react8.useRef)(connectionStatus);
  (0, import_react8.useEffect)(() => {
...
function useInstalledWallets() {
  ...
  if (assertWindowEthereum(window_)) {
    isMetamaskInstalled = !!((_a = window_.ethereum) == null ? void 0 : _a.isMetaMask);
    isCoinbaseWalletInstalled = !!((_b = window_.ethereum) == null ? void 0 : _b.isCoinbaseWallet) || !!((_d = (_c = window_.ethereum) == null ? void 0 : _c.providers) == null ? void 0 : _d.some((p) => p.isCoinbaseWallet));
    isZerionWalletInstalled = !!((_e = window_.ethereum) == null ? void 0 : _e.isZerion);
    isTrustWalletInstalled = !!((_f = window_.ethereum) == null ? void 0 : _f.isTrust);
  }
  return {
...
function useRainbowWallet() {
  ...
  return (0, import_react8.useCallback)(async (connectOptions) => {
    const {
      rainbowWallet: rainbowWallet2
    } = await import("./RainbowWallet-192b2f1a.browser.esm-N6JW3IKW.js");
...
function useTrustWallet() {
  ...
  return (0, import_react8.useCallback)(async (connectOptions) => {
    ...
    } = await import("./TrustWallet-e6a998cd.browser.esm-KBKHD4BN.js");
...
function useMetamask() {
  ...
  return (0, import_react8.useCallback)(async (connectOptions) => {
    ...
    } = await import("./headlessConnectUI-c1f84a4b.browser.esm-Q262RKGD.js").then(function(n) {
      return n.v;
    });
...
function useFrameWallet() {
  ...
  return (0, import_react8.useCallback)(async (connectOptions) => {
    ...
    } = await import("./frameWallet-b3718578.browser.esm-475PX7ON.js");
    return connect(frameWallet2(), connectOptions);
  }, [connect]);
}
function useBloctoWallet() {
  const connect = useConnect();
  return (0, import_react8.useCallback)(async (options) => {
    const {
      bloctoWallet: bloctoWallet2
    } = await import("./bloctoWallet-ae3d0f5d.browser.esm-YQLZI2JA.js");
...
function usePaperWallet() {
  ...
  return (0, import_react8.useCallback)(async (options) => {
    ...
    } = await import("./paperWallet-603d0002.browser.esm-RSTOEYZ7.js");
...
function useWalletConnectV1() {
  ...
  return (0, import_react8.useCallback)(async (options) => {
    ...
    } = await import("./walletConnectV1-2f66a05d.browser.esm-T4MCU6GI.js");
...
// node_modules/@thirdweb-dev/react/dist/useSafe-b6433e6d.browser.esm.js
init_shim();
var import_react10 = __toESM(require_react());
function useSafe() {
  const connect = useConnect();
  return (0, import_react10.useCallback)(async (connectProps) => {
    const {
      safeWallet: safeWallet2
    } = await import("./safeWallet-213213a1.browser.esm-IEVYZQES.js");
    return connect(safeWallet2(), connectProps);
  }, [connect]);
}

// node_modules/@thirdweb-dev/react/dist/useMagic-3c5e050f.browser.esm.js
init_shim();
var import_react11 = __toESM(require_react());
function useMagic() {
  const connect = useConnect();
  return (0, import_react11.useCallback)(async (options) => {
    const {
      magicLink: magicLink2
    } = await import("./magicLink-fb30cfdc.browser.esm-BUFNREUZ.js");
...
function useLocalWalletInfo(localWalletConfig, persist) {
  const [walletData, setWalletData] = (0, import_react12.useState)("loading");
  const createWalletInstance = useCreateWalletInstance();
  const [localWallet2, setLocalWallet] = (0, import_react12.useState)(null);
...
var DragNDrop = (props) => {
  ...
  const [uploaded, setUploaded] = (0, import_react12.useState)();
...
var LocalWalletModalHeader = (props) => {
  return (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, {
    children: [!props.hideBack && (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, {
...
var ImportLocalWallet = (props) => {
  const [jsonString, setJsonString] = (0, import_react12.useState)();
  const {
    setLocalWallet,
    meta
  ...
  const [importedAddress, setImportedAddress] = (0, import_react12.useState)();
  const {
    setConnectedWallet,
    setConnectionStatus
  } = useWalletContext();
...
var CreateLocalWallet_Password = (props) => {
  const [password, setPassword] = (0, import_react12.useState)("");
  const [confirmPassword, setConfirmPassword] = (0, import_react12.useState)("");
  const [showPassword, setShowPassword] = (0, import_react12.useState)(false);
  ...
  const [showImportScreen, setShowImportScreen] = (0, import_react12.useState)(false);
  const [generatedAddress, setGeneratedAddress] = (0, import_react12.useState)(null);
  (0, import_react12.useEffect)(() => {
...
var CreateLocalWallet_Guest = (props) => {
  ...
  const handleConnect = (0, import_react12.useCallback)(async () => {
    if (!localWallet2) {
      throw new Error("Invalid state");
    }
  ...
  const connecting = (0, import_react12.useRef)(false);
  (0, import_react12.useEffect)(() => {
...
var ReconnectLocalWallet = (props) => {
  ...
  const [isConnecting, setIsConnecting] = (0, import_react12.useState)(false);
  const [showCreate, setShowCreate] = (0, import_react12.useState)(false);
  const [showBackupConfirmation, setShowBackupConfirmation] = (0, import_react12.useState)(false);
  const [showExport, setShowExport] = (0, import_react12.useState)(false);
  const {
    localWallet: localWallet2,
    meta,
    walletData
...
var SmartWalletConnecting = (props) => {
  ...
  const [connectError, setConnectError] = (0, import_react12.useState)(false);
  const [switchError, setSwitchError] = (0, import_react12.useState)(false);
  const [switchingNetwork, setSwitchingNetwork] = (0, import_react12.useState)(false);
  const connectionStatus = useConnectionStatus();
  const requiresConfirmation = !useIsHeadlessWallet();
  const {
    onConnect
  } = props;
  const connectStarted = (0, import_react12.useRef)(false);
  const switchChain = useSwitchChain();
  const handleConnect = (0, import_react12.useCallback)(async () => {
...
var SelectPersonalWallet = (props) => {
  ...
  const selected = (0, import_react12.useRef)(false);
  (0, import_react12.useEffect)(() => {
    if (selected.current) {
      return;
    }
  ...
  return (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, {
    children: [props.renderBackButton && (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, {
      children: [(0, import_jsx_runtime2.jsx)(BackButton, {
        onClick: props.onBack
      }), (0, import_jsx_runtime2.jsx)(Spacer, {
        y: "md"
...
var SmartConnectUI = (props) => {
  ...
  const [personalWalletConfig, setPersonalWalletConfig] = (0, import_react12.useState)();
...
var ZerionConnectUI = (props) => {
  var _a, _b, _c;
  const [screen, setScreen] = (0, import_react12.useState)("connecting");
  const {
    walletConfig,
    close
  } = props;
  ...
  if (screen === "open-wc-uri") {
    return (0, import_jsx_runtime2.jsx)(WCOpenURI, {
      hideBackButton,
      onBack: props.goBack,
      onConnected: close,
      walletConfig,
