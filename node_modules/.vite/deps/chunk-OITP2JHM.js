...
// node_modules/@thirdweb-dev/sdk/dist/abi-cc94befa.browser.esm.js
init_shim();
...
async function getPolygonGasPriorityFee(chainId) {
  ...
  try {
    const data = await (await (0, import_cross_fetch.default)(gasStationUrl)).json();
...
// node_modules/@thirdweb-dev/sdk/dist/sdk-761ed71c.browser.esm.js
init_shim();
init_lib();
...
async function verify(contractAddress, chainId, explorerAPIUrl, explorerAPIKey, storage, encodedConstructorArgs) {
  try {
    ...
    const result = await (0, import_cross_fetch2.default)(explorerAPIUrl, {
      method: "POST",
      headers: {
...
async function checkVerificationStatus(explorerAPIUrl, explorerAPIKey, guid) {
  ...
  return new Promise((resolve, reject) => {
    const intervalId = setInterval(async () => {
      try {
        const result = await (0, import_cross_fetch2.default)(endpoint, {
          method: "GET"
        });
        const data = await result.json();
...
async function directDeployDeterministic(bytecode, abi, signer, constructorArgs, saltForCreate2) {
  ...
  const encodedArgs = utils_exports.defaultAbiCoder.encode(constructorParamTypes, paramValues);
...
var ContractDeployer = class extends RPCConnectionHandler {
  constructor(network, options, storage) {
    ...
    __publicField(this, "deployOpenEdition", buildDeployTransactionFunction(async (metadata, options) => {
      ...
      return await this.deployReleasedContract.prepare(THIRDWEB_DEPLOYER2, "OpenEditionERC721", deployArgs, options);
    }));
    ...
    __publicField(this, "deployProxy", buildDeployTransactionFunction(async (implementationAddress, implementationAbi, initializerFunction, initializerArgs) => {
      ...
      const {
        TWProxy__factory
      } = await import("./thirdweb-dev-contracts-js-factories-TWProxy__factory.browser.esm-RCU32GRS.js");
...
// node_modules/@thirdweb-dev/sdk/dist/watchTransactions-1659d86c.browser.esm.js
init_shim();
init_lib();
...
//# sourceMappingURL=chunk-OITP2JHM.js.map
