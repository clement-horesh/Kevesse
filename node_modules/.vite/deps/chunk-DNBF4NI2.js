...
var B = (s) => `paperEwsWalletUserDetails-${s}`;
...
var I = (s, e2) => `${Q}-${s}-${e2}`;
var K = (s) => `${Q}-${s}`;
var S = ((t) => (t.USER_MANAGED = "USER_MANAGED", t.AWS_MANAGED = "AWS_MANAGED", t))(S || {});
var X = ((n) => (n.PAPER_EMAIL_OTP = "PaperEmailOTP", n.GOOGLE = "Google", n.TWITTER = "Twitter", n.COGNITO = "Cognito", n.AUTH0 = "Auth0", n.CUSTOM_JWT = "CustomJWT", n))(X || {});
...
var Y = { height: "100%", width: "100%", border: "none", backgroundColor: "transparent", colorScheme: "light", position: "fixed", top: "0px", right: "0px", zIndex: "2147483646", display: "none" };
...
var v = class {
  constructor({ link: e2, iframeId: t, container: i2 = document.body, iframeStyles: a, onIframeInitialize: o2 }) {
    ...
    let n = document.getElementById(t), p = new URL(e2), l = "1.1.3";
    if (!l)
  ...
  call(o2) {
    return r2(this, arguments, function* ({ procedureName: e2, params: t, showIframe: i2 = false, injectRecoveryCode: a = { isInjectRecoveryCode: false } }) {
      for (; !N.get(this.iframe.src); )
        yield f(this.POLLING_INTERVAL_SECONDS);
      return i2 && (this.iframe.style.display = "block", yield f(5e-3)), new Promise((p, l) => {
        var R;
        if (a.isInjectRecoveryCode) {
          let g = (m) => r2(this, null, function* () {
            ...
            if (m.origin !== i() || m.data.type !== "paper_getRecoveryCode" || typeof m.data.userWalletId != "string")
              return;
            let j = yield (b = a.getRecoveryCode) == null ? void 0 : b.call(a, m.data.userWalletId);
        ...
        d.port1.onmessage = (g) => r2(this, null, function* () {
          let { data: m } = g;
          d.port1.close(), i2 && (yield f(0.1), this.iframe.style.display = "none"), m.success ? p(m.data) : l(new Error(m.error));
...
var C = class extends v {
  constructor({ clientId: t, customizationOptions: i2 }) {
    super({ iframeId: re, link: te({ clientId: t, path: E, queryParams: i2 }).href, container: document.body });
    this.clientId = t;
  }
  onIframeLoadedInitVariables() {
    return r2(this, null, function* () {
...
function te({ clientId: s, path: e2, queryParams: t }) {
  var a;
  let i2 = new URL(e2, i());
  if (t)
...
var re = "paper-embedded-wallet-iframe";
var h = class {
...
var M = class {
  ...
  getEthersJsSigner(e2) {
    return r2(this, null, function* () {
      var i2;
      return new y({ clientId: this.clientId, provider: getDefaultProvider((i2 = e2 == null ? void 0 : e2.rpcEndpoint) != null ? i2 : e[this.chain]), querier: this.walletManagerQuerier });
    });
  }
};
var U = class {
...
//# sourceMappingURL=chunk-DNBF4NI2.js.map
