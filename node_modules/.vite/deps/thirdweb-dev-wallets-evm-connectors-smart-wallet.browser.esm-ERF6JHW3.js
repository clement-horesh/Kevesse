  ...
  async createUnsignedUserOp(info, batched) {
    ...
    if (!maxFeePerGas || !maxPriorityFeePerGas) {
      ...
      if (!maxFeePerGas) {
        ...
        if (maxPriorityFeePerGas && (chainId === c80001.chainId || chainId === c137.chainId)) {
          const block = await this.provider.getBlock("latest");
          const baseBlockFee = block && block.baseFeePerGas ? block.baseFeePerGas : utils_exports.parseUnits("1", "gwei");
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-smart-wallet.browser.esm-ERF6JHW3.js.map
