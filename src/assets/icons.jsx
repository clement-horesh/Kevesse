...
const Icons = ({ color, size = 24, iconType }) => {
  const originalViewBoxSize = 24;
  ...
  return (
    <svg
      width={`${size}px`}
      height={`${size}px`}
      viewBox={`0 0 ${originalViewBoxSize} ${originalViewBoxSize}`}
      strokeWidth="1.5"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      style={{ color: color }} // Set color here
    >
      {getIconPath()}
    </svg>
  );
